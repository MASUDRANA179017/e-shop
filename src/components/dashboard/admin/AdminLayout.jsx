...
import { BiHome, BiLogOut, BiSolidCategory, BiUser, BiMenu, BiX, BiMoneyWithdraw } from "react-icons/bi";
import { CiSettings } from "react-icons/ci";
import { FaShoppingCart, FaStore, FaBoxOpen, FaClipboardList, FaWallet, FaUsers } from "react-icons/fa";
...
const AdminLayout = () => {
  ...
  const navItems = [
    { to: "/dashboard/admin", label: "Home", icon: <BiHome size={20} /> },
    { to: "/dashboard/admin/users", label: "Users List", icon: <FaUsers size={20} /> },
    { to: "/dashboard/admin/category", label: "Category List", icon: <BiSolidCategory size={20} /> },
    { to: "/dashboard/admin/stores", label: "Services List", icon: <FaStore size={20} /> },
    { to: "/dashboard/admin/products", label: "Products List", icon: <FaBoxOpen size={20} /> },
    { to: "/dashboard/admin/bookings", label: "My Bookings", icon: <FaClipboardList size={20} /> },
    { to: "/dashboard/admin/wallet", label: "Wallet", icon: <FaWallet size={20} /> },
    { to: "/dashboard/admin/withdrawals", label: "Withdrawals", icon: <BiMoneyWithdraw size={20} /> },
    { to: "/dashboard/admin/profile", label: "Profile", icon: <BiUser size={20} /> },
    { to: "/dashboard/admin/settings", label: "Settings", icon: <CiSettings size={20} /> },
  ];
    ...
    <div className="flex min-h-screen bg-gray-100 relative">
      ...
      >
        <div className="p-5 flex justify-between items-center border-b border-gray-200">
            <span className="font-bold text-2xl text-blue-600">Admin Panel</span>
            <button 
                onClick={() => setIsSidebarOpen(false)}
